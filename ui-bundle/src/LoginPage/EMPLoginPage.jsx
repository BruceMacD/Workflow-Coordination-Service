...
class EMPLoginPage extends React.Component {

    constructor(props) {
        super(props);

        // reset login status
        this.props.dispatch(userActions.logout(portalConstants.EMP_PORTAL));
    ...
    handleSubmit(e) {
        ...
        if (id && password) {
            dispatch(userActions.login(portalConstants.EMP_PORTAL, id, password));
        }
    }
    ...
    handleCreateUser(e) {
        ...
        if (username && newPassword) {
            dispatch(empActions.createUser(username, newPassword));
...
function mapStateToProps(state) {
    const { loggingIn } = state.empAuthentication;
...
const connectedEMPLoginPage = connect(mapStateToProps)(EMPLoginPage);
export { connectedEMPLoginPage as EMPLoginPage }; 